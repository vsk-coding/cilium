...
func (o *GetHealthzInternalServerError) WithPayload(payload *models.StatusResponse) *GetHealthzInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get healthz internal server error response
func (o *GetHealthzInternalServerError) SetPayload(payload *models.StatusResponse) {
	o.Payload = payload
}
